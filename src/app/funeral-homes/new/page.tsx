...
export default function NewFuneralHomePage() {
  ...
  const handleAddressChange = (value: string, details?: {
    ...
    if (details) {
      // Autocomplete filled in the address details
      setFormData((prev) => ({
        ...prev,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.error || "Failed to create funeral home")
      }

      // Success - redirect to funeral homes list
      router.push("/funeral-homes")
      router.refresh()
    } catch (err) {
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Add New Funeral Home</h1>
              <p className="text-gray-600">Enter the details for your new funeral home location</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-3 pt-4 border-t">
              ...
              <Button type="submit" disabled={loading}>
                ...
                {loading ? "Saving..." : "Save Funeral Home"}
              </Button>
            </div>
          </form>
        </div>
