...
export default async function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        {isNewOrganization && (
          <div className="mb-8 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-8 text-white">
            <h2 className="text-2xl font-bold mb-4">🎉 Welcome to Your Business Management System!</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <span className="bg-white text-blue-600 rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">1</span>
                  <h3 className="font-semibold">Add Funeral Homes</h3>
                </div>
                <p className="text-sm text-blue-100">Set up your funeral home locations</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <span className="bg-white text-blue-600 rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">2</span>
                  <h3 className="font-semibold">Add Suppliers</h3>
                </div>
                <p className="text-sm text-blue-100">Connect with your suppliers</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <span className="bg-white text-blue-600 rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">3</span>
                  <h3 className="font-semibold">Add Products</h3>
                </div>
                <p className="text-sm text-blue-100">Build your product catalog</p>
              </div>
            </div>
          </div>
        )}
