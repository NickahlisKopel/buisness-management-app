      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {suppliers.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm sm:text-base font-medium text-gray-900">No suppliers</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {suppliers.map((supplier: any) => (
              <div key={supplier.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                <div className="flex items-start justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-2 sm:ml-3">
                      ...
                      <p className={`text-xs sm:text-sm ${supplier.isActive ? 'text-green-600' : 'text-red-600'}`}>
